...
const PatternCard = ({ pattern, onViewDetail }) => {
  ...
  return (
    <div className={`fp-card fp-card-${pattern.riskLevel}`} onClick={() => onViewDetail(pattern)}>
      {/* Top bar */}
      ...
      <div className="fp-card-inner">
        ...
        <div className="fp-card-header">
          <div className="fp-card-icon-wrap" style={{ background: `${riskColor}18`, color: riskColor }}>
        ...
        <div className="fp-card-metrics">
          ...
          <div className="fp-metric">
            <span className="fp-metric-value">{pattern.falsePositiveRate}%</span>
        ...
        <div className="fp-card-footer">
          ...
          <button className="fp-card-detail-btn" onClick={e => { e.stopPropagation(); onViewDetail(pattern); }}>
