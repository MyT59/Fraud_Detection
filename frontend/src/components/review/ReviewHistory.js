...
const SAMPLE = [
  { id:1,  transactionId:'AGN-000008', action:'rejected',  reviewer:'Admin User',  reviewerRole:'Senior Analyst',  timestamp:new Date().toISOString(),                      amount:895000,  riskScore:96, duration:'4 minutes', notes:'Multiple patterns confirmed: bruteforce PIN + money mule destination. Account blocked.' },
  { id:2,  transactionId:'NUS-000009', action:'rejected',  reviewer:'Jane Smith',  reviewerRole:'Fraud Analyst',   timestamp:new Date(Date.now()-3600000).toISOString(),    amount:315845,  riskScore:95, duration:'5 minutes', notes:'Refund abuse + burst payment pattern via API channel. Transaction reversed.' },
  { id:3,  transactionId:'AGN-000003', action:'escalated', reviewer:'John Doe',    reviewerRole:'Junior Analyst',  timestamp:new Date(Date.now()-7200000).toISOString(),    amount:234802,  riskScore:78, duration:'8 minutes', notes:'Midnight withdrawal pattern — requires senior approval before blocking.' },
  { id:4,  transactionId:'AGN-000007', action:'approved',  reviewer:'Sarah W.',    reviewerRole:'Fraud Analyst',   timestamp:new Date(Date.now()-10800000).toISOString(),   amount:130227,  riskScore:52, duration:'2 minutes', notes:'Score above threshold but no pattern matched. Verified with account holder.' },
  { id:5,  transactionId:'NUS-000001', action:'rejected',  reviewer:'Admin User',  reviewerRole:'Senior Analyst',  timestamp:new Date(Date.now()-18000000).toISOString(),   amount:412500,  riskScore:94, duration:'6 minutes', notes:'Burst payment + sudden API channel switch + refund abuse. Customer account suspended.' },
  { id:6,  transactionId:'NUS-000008', action:'approved',  reviewer:'Rina Sari',   reviewerRole:'Fraud Analyst',   timestamp:new Date(Date.now()-21600000).toISOString(),   amount:280575,  riskScore:50, duration:'2 minutes', notes:'Customer confirmed API channel change was intentional — migrating from Web.' },
  { id:7,  transactionId:'AGN-000004', action:'flagged',   reviewer:'John Doe',    reviewerRole:'Junior Analyst',  timestamp:new Date(Date.now()-25200000).toISOString(),   amount:226048,  riskScore:61, duration:'4 minutes', notes:'Impossible terminal switch detected — flagged for senior review.' },
  { id:8,  transactionId:'NUS-000002', action:'rejected',  reviewer:'Jane Smith',  reviewerRole:'Fraud Analyst',   timestamp:new Date(Date.now()-28800000).toISOString(),   amount:275000,  riskScore:87, duration:'5 minutes', notes:'REFUND_FLAG=1 combined with underpayment and burst pattern. Rejected.' },
  { id:9,  transactionId:'AGN-000006', action:'approved',  reviewer:'Admin User',  reviewerRole:'Senior Analyst',  timestamp:new Date(Date.now()-86400000).toISOString(),   amount:184311,  riskScore:57, duration:'3 minutes', notes:'Midnight flag but single pattern only. Customer OTP verified.' },
  { id:10, transactionId:'NUS-000003', action:'escalated', reviewer:'Budi S.',     reviewerRole:'Junior Analyst',  timestamp:new Date(Date.now()-90000000).toISOString(),   amount:198000,  riskScore:76, duration:'6 minutes', notes:'Payment spike + burst pattern — escalated for further review by compliance.' },
  { id:11, transactionId:'AGN-000005', action:'approved',  reviewer:'Sarah W.',    reviewerRole:'Fraud Analyst',   timestamp:new Date(Date.now()-172800000).toISOString(),  amount:142014,  riskScore:60, duration:'3 minutes', notes:'Terminal switch detected but geo-verified. Approved after confirmation.' },
  { id:12, transactionId:'NUS-000004', action:'flagged',   reviewer:'Rina Sari',   reviewerRole:'Fraud Analyst',   timestamp:new Date(Date.now()-180000000).toISOString(),  amount:357477,  riskScore:65, duration:'4 minutes', notes:'Sudden API channel switch — flagged, pending customer verification.' },
];
