...
const ActivityStats = ({ logs }) => {
  ...
  const stats = [
    { icon: 'bi-journal-text',    label: 'Total Log',      value: total,    cls: 'as-total'   },
    { icon: 'bi-person-plus',     label: 'Dibuat',         value: creates,  cls: 'as-create'  },
    { icon: 'bi-pencil-square',   label: 'Diedit',         value: edits,    cls: 'as-edit'    },
    { icon: 'bi-pause-circle',    label: 'Disuspend',      value: suspends, cls: 'as-suspend' },
