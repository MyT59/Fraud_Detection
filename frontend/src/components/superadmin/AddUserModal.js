        ...
        <div className="aum-header">
          <div className="aum-header-left">
            <div className="aum-icon">
              <i className={`bi ${isEdit ? 'bi-pencil-square' : 'bi-person-plus-fill'}`} />
            </div>
            <div>
              <p className="aum-title">{isEdit ? 'Edit Pengguna' : 'Tambah Pengguna Baru'}</p>
              <p className="aum-subtitle">
                {isEdit ? 'Perbarui informasi pengguna yang ada' : 'Isi detail untuk membuat akun baru'}
              </p>
            </div>
          </div>
        ...
        <div className="aum-footer">
          ...
          <button className="aum-btn-submit" onClick={handleSubmit} disabled={loading}>
            {loading
              ...
              : <><i className={`bi ${isEdit ? 'bi-check-lg' : 'bi-plus-lg'}`} />{isEdit ? 'Simpan Perubahan' : 'Buat Pengguna'}</>
            }
          </button>
        </div>
